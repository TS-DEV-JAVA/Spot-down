...
OUTPUT = config.get("output", "downloads")
...
# search
console.print(Panel("[bold magenta] Spot-down-search-downloader[/bold magenta]", style="bold purple", expand=False))
...
# summary/meta table
summary = f"""
[bold cyan]{track_name}[/bold cyan]
[bold blue]{track_artists}[/bold blue]

Format: [bold magenta]{FORMAT}[/bold magenta]
...
console.print(f"\n[bold purple] Downloading...[/bold purple]")
try:
    subprocess.run(cmd, check=True)
    console.print(f"[bold green] Done! Saved in [underline]{OUTPUT}[/underline][/bold green]")
